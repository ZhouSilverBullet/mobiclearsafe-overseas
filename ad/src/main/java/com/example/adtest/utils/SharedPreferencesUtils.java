...
public class SharedPreferencesUtils {
     ...
     * 保存在手机里面的文件名
     */
//    private static final String FILE_NAME = "App_dataSet";
    private static final String FILE_NAME = "SDK_data";
    ...
    public static void loadArray(Context mContext, List<String> list) {
    ...
    public static void putHashMapData(Context context, String key, Map<String, Boolean> datas) {
    ...
    public static Map<String, Boolean> getHashMapData(Context context, String key) {
