...
public class FileScanLayout extends View {
    public static final String TAG = "FileScanLayout";
    Paint paint;
    Paint mMemoryPaint;
    Paint mMemoryPaint2;
    Paint mMemoryPaint3;
    ...
    private String mPath = Environment.getDataDirectory().getPath();
    //显示文字
    private String showText = "";

    public FileScanLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        ...
        mMemoryPaint.setTextSize(UiUtils.dp2px(getContext(), 15));
        ...
        mMemoryPaint3.setTextSize(UiUtils.dp2px(getContext(), 35));
...
//        canvas.drawText(mPath, (getWidth()) / 2.0f, dp350 + baseline + dp15, mMemoryPaint);
//        canvas.drawText("内存占用超过", (getWidth()) / 2.0f, dp350, mMemoryPaint2);
//        canvas.drawText("正在扫描", (getWidth()) / 2.0f, getHeight() / 2.0f, mMemoryPaint3);
        canvas.drawText(showText, (getWidth()) / 2.0f, getHeight() / 2.0f, mMemoryPaint3);
