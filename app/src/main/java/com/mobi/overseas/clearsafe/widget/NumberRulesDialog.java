 ...
 * desc: 集数字活动规则
 */
public class NumberRulesDialog  extends BaseDialog implements View.OnClickListener {
    ...
    public NumberRulesDialog(Builder builder) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.numcard_rules_layout);
        initView();
        initWindow();
    }
...
//        lps.height = WindowManager.LayoutParams.WRAP_CONTENT;
    ...
    public static class Builder {
        ...
        public NumberRulesDialog build() {
            return new NumberRulesDialog(this);
        }
