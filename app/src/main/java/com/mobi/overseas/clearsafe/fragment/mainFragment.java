...
import com.mobi.overseas.clearsafe.greendao.TodayStepData;
import com.mobi.overseas.clearsafe.greendao.TodayStepSessionUtils;
...
import com.mobi.overseas.clearsafe.main.StepBubble;
...
import com.mobi.overseas.clearsafe.utils.imageloader.CornerTransform;
import com.mobi.overseas.clearsafe.utils.imageloader.Utils;
import com.mobi.overseas.clearsafe.widget.AcceleratorCardDialog;
import com.mobi.overseas.clearsafe.widget.CustomDashboard;
...
import com.mobi.overseas.clearsafe.widget.PlaqueDialog;
import com.mobi.overseas.clearsafe.widget.StepCeilingNewDialog;
    ...
    private void initView() {
        ...
        adapter = new CommonAdapter<BannerBean.HotActivityList>(getContext(), R.layout.item_hotact_layout, hotActivityLists) {
            ...
            public void convert(RecycleViewHolder holder, final BannerBean.HotActivityList item) {
                ...
                com.mobi.overseas.clearsafe.utils.imageloader.ImageLoader.loadImage(getContext(), iv_bg, item.url);
...
//                                            }).build();
                            ...
                            if (demo.hot_activity_list != null && demo.hot_activity_list.size() > 0) {
                                if (demo.hot_activity_list.get(0) != null) {
                                    com.mobi.overseas.clearsafe.utils.imageloader.ImageLoader.loadImage(getContext(), image_two, demo.hot_activity_list.get(0).url);
                                ...
                                if (demo.hot_activity_list.get(1) != null) {
                                    com.mobi.overseas.clearsafe.utils.imageloader.ImageLoader.loadImage(getContext(), image_one, demo.hot_activity_list.get(1).url);
                            ...
                            if (demo.red_envelope != null) {
                                if (!TextUtils.isEmpty(demo.red_envelope.url) && !TextUtils.isEmpty(demo.red_envelope.jump_url)) {
                                    ...
                                    com.mobi.overseas.clearsafe.utils.imageloader.ImageLoader.loadImage(getContext(), iv_float, demo.red_envelope.url);
