 ...
 * desc: 新版金币弹框
 */
public class GetGoldNewDialog extends BaseDialog implements View.OnClickListener {
    ...
    private ImageView bg_light, lable, ivClose;
    ...
    public GetGoldNewDialog(Builder builder) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gold_newdialog_layout);
        setCancelable(false);
    ...
    private void initView() {
        ...
        if (!TextUtils.isEmpty(title)) {
            ...
            if (fanbei_title) {
                ...
                tv_title.setText(mContext.getResources().getString(R.string.new_dialog_title));
            }
        }
        ...
        boolean hwIsShowAd = AppUtil.HWIsShowAd();
        if (hwIsShowAd == false ? false : isShowAd) {
...
//        lps.height = WindowManager.LayoutParams.WRAP_CONTENT;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_continue:
                if (mClick != null) {
                    mClick.closeBtnClick(GetGoldNewDialog.this);
                }
                break;
            case R.id.tv_double:
                if (mClick != null) {
                    mClick.doubleBtnClick(GetGoldNewDialog.this);
                }
                break;
            case R.id.tv_agin:
                if (mClick != null) {
                    mClick.bottomBtnClick(GetGoldNewDialog.this);
                }
                break;
        }
    }
    ...
    public static class Builder {
        ...
        public GetGoldNewDialog build() {
            return new GetGoldNewDialog(this);
        }
    }
