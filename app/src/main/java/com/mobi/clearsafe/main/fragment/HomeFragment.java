...
import com.mobi.clearsafe.ui.appwiget.CleanAppWidget;
...
import com.mobi.clearsafe.ui.clear.control.scan.CleanQQTask;
...
import com.mobi.clearsafe.ui.repair.PermissionRepairActivity;
...
//        des2.setText(hotActivityList2.content);
        ...
        if (envelope != null) {
            if (!TextUtils.isEmpty(envelope.url) && !TextUtils.isEmpty(envelope.jump_url)) {
                ...
                com.mobi.clearsafe.utils.imageloader.ImageLoader.loadImage(getContext(), ivFloat, envelope.url);
