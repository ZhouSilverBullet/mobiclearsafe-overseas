package com.mobi.clearsafe.ui.clear.widget.dustbinview;
...
import com.mobi.clearsafe.ui.clear.entity.AppProcessInfo;
...
public class DustbinView extends View {
    ...
    private static final int DEFAULT_RECYCLER_TIME = 1500;
    ...
    private Paint mBitmMyApplicationaint;
...
//        List<AppProcessInfo> mProcessList = ProcessManager.getInstance().getRunningProcessList();
        List<AppProcessInfo> mProcessList = new ArrayList<>();
        ...
        //画笔
        mBitmMyApplicationaint = new Paint();
        mBitmMyApplicationaint.setAntiAlias(true);
        mBitmMyApplicationaint.setDither(true);
        mBitmMyApplicationaint.setFilterBitmap(true);
        mBitmMyApplicationaint.setColor(Color.WHITE);
    ...
    private void drawDustbin(Canvas canvas) {
        ...
        canvas.drawBitmap(mDustbinBitmap, mMatrix, mBitmMyApplicationaint);
        mMatrix.reset();
    }
    ...
    private void calculatePointAndFade() {
        ...
        mBitmMyApplicationaint.setAlpha(mAlpha);
    ...
    public void startAnimation() {
        ...
        shakeAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                if (mListener != null) {
                    mListener.onShakeDustbin(shakeAnimator);
                }
            }
    ...
    public interface IAnimationListener {
        ...
        void onShakeDustbin(ValueAnimator shakeAnimator);
    ...
    private class IconInfo {
        ...
        public IconInfo(Bitmap bitmap) {
            ...
            if (nextRandom == 0) {
                ...
                direction = 1;
                startX = MyApplication.sWidth;
            }
            controlPoint = new Point();
            controlPoint.x = MyApplication.sWidth / 2;
            controlPoint.y = (int) (random.nextFloat() * 0.5 * MyApplication.sHeight);
        }
